...
CLI
---
    python .harness/scripts/check_computation_resumable.py --project <project_dir>
    python .harness/scripts/check_computation_resumable.py --project <project_dir> --json
    python .harness/scripts/check_computation_resumable.py --project <project_dir> --clear <stem>
...
def format_report(records: list[dict]) -> str:
    ...
    if orphaned:
        lines.append("")
        lines.append(
            "To resume: import CheckpointManager from .harness/scripts/run_with_checkpoint.py "
