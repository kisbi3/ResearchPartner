...
ACTION_GUIDANCE = {
    "Orient Note": {
        ...
        "suggested_command": "python .harness/scripts/check_orient_recorded.py --project <project-dir>",
    },
    "Interview Notes": {
        "why": "Confirm the research question, assumptions, agreed direction, and next skill are recorded.",
        "suggested_command": "python .harness/scripts/check_interview_recorded.py --project <project-dir>",
    },
    "Literature Review Plan": {
        "why": "Confirm literature status before model specification or seed design relies on novelty or reproduction claims.",
        "suggested_command": "python .harness/scripts/check_literature_reviewed.py --project <project-dir>",
    },
    "Model Spec": {
        "why": "Approve the model definition before seed design or execution depends on it.",
        "suggested_command": "python .harness/scripts/check_model_specified.py --project <project-dir>",
    },
    "Baseline Strategy": {
        "why": "Approve whether this run reproduces a parent model or verifies a new analytical checkpoint.",
        "suggested_command": "python .harness/scripts/check_baseline_strategy.py --project <project-dir>",
    },
    "Baseline Registry": {
        "why": "Check that interpretation is backed by a toy model, known limit, reproduction, or explicit waiver.",
        "suggested_command": "python .harness/scripts/check_baseline_gate.py --project <project-dir>",
    },
    "Validation Log": {
        "why": "Review the current evidence chain before treating results as interpretation-ready.",
        "suggested_command": "python .harness/scripts/check_figure_provenance.py --root <run-dir>",
    },
    "Live Workflow Diagram": {
        "why": "Review active workflow state, blocked behavior, stale artifacts, and next researcher checkpoint.",
        "suggested_command": "python .harness/scripts/generate_workflow_map.py",
    },
    "Literature Summary": {
        "why": "Review compiled paper context summaries before model specification or replanning decisions.",
        "suggested_command": "python .harness/scripts/compile_literature_summary.py --project <project-dir>",
    },
}
