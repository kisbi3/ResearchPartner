...
SCENARIOS = [
    ...
    Scenario(
        ...
        docs=(
            ...
            ".harness/scripts/scaffold_paper_review.py",
            ".harness/scripts/extract_paper_text.py",
            ".harness/scripts/draft_paper_review.py",
            ".harness/scripts/process_paper_for_review.py",
            ".harness/scripts/check_paper_review_quality.py",
        ),
        rule_terms=(
    ...
    Scenario(
        ...
        docs=(
            ".harness/scripts/init_research_project.py",
            ".harness/scripts/sync_workflow.py",
            "docs/workflow_overview.md",
        ),
        rule_terms=(
    ...
    Scenario(
        ...
        docs=(
            ...
            ".harness/scripts/check_claim_promotion.py",
            ".harness/scripts/check_claim_promotion_freshness.py",
        ),
        rule_terms=(
    ...
    Scenario(
        ...
        skills=("skills/sync-workflow/SKILL.md",),
        docs=(".harness/scripts/sync_workflow.py",),
        rule_terms=(
    ...
    Scenario(
        ...
        docs=(
            ".harness/scripts/_layout.py",
            ".harness/scripts/run_with_capture.py",
            ".harness/scripts/audit_run_outputs.py",
        ),
        rule_terms=(
    ...
    Scenario(
        ...
        docs=(
            ".harness/scripts/check_session_resumable.py",
            ".harness/scripts/workflow_hooks.py",
            "docs/run_templates/live_workflow_diagram_template.md",
        ),
        rule_terms=(
    ...
    Scenario(
        ...
        docs=(
            ".harness/scripts/run_with_checkpoint.py",
            ".harness/scripts/check_computation_resumable.py",
        ),
        rule_terms=(
    ...
    Scenario(
        ...
        docs=(
            ...
            ".harness/scripts/check_harness_manifest.py",
    ...
    Scenario(
        ...
        docs=(
            ...
            ".harness/scripts/check_spawn_contracts.py",
...
def run_claim_promotion_lifecycle_check() -> list[str]:
    module_path = ROOT / ".harness" / "scripts" / "check_claim_promotion.py"
...
def run_ci_enforcement_check() -> list[str]:
    ...
    required_terms = [
        ...
        "python .harness/scripts/check_domain_manifest.py",
