...
Backstop for the PreToolUse hook (.harness/scripts/check_src_write_authorization.py).
...
Usage:
    python .harness/scripts/check_cross_tier_compliance.py --project <project-dir>
    python .harness/scripts/check_cross_tier_compliance.py --project <project-dir> --strict
