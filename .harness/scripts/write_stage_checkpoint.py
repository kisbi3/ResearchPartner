...
Usage:
    python .harness/scripts/write_stage_checkpoint.py --project <project-dir> --stage 2 \
...
- Generator: `.harness/scripts/write_stage_checkpoint.py`
...
> unanchored. The coverage gate (`.harness/scripts/check_lineage_coverage.py --run
