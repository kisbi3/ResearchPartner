...
Usage
-----
    python .harness/scripts/check_lineage_coverage.py --project <project-dir>
    python .harness/scripts/check_lineage_coverage.py --project <project-dir> --strict
    python .harness/scripts/check_lineage_coverage.py --project <project-dir> --json
"""
...
def check(run_root: Path) -> list[dict]:
    ...
    if not data:
        return [{
            ...
            "fix": f"Run .harness/scripts/init_research_project.py --project {run_root} first.",
        }]
