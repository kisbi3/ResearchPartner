...
Usage
-----
    python .harness/scripts/run_with_capture.py <run_dir> <script_path> [args...]
    python .harness/scripts/run_with_capture.py --quiet <run_dir> <script_path> [args...]

Examples
--------
    python .harness/scripts/run_with_capture.py C:/MyProject src/simulate.py
    python .harness/scripts/run_with_capture.py . src/scan.py --k 60 --omega0 20
    python .harness/scripts/run_with_capture.py --quiet --tail 30 . src/scan.py
