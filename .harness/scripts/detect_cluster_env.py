...
Usage:
    python .harness/scripts/detect_cluster_env.py
    python .harness/scripts/detect_cluster_env.py --project <project-dir>
    python .harness/scripts/detect_cluster_env.py --json   # machine-readable
"""
