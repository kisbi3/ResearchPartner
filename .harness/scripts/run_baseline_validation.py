...
REQUIRED_PATHS = [
    ...
    ".harness/scripts/audit_existing_project.py",
    ".harness/scripts/evaluate_harness.py",
    ".harness/scripts/generate_workflow_map.py",
    ".harness/scripts/validate_workflow_links.py",
]
