...
|---|---|---|
| **Current Run Dashboard** | `workflow_map.html` | unified run-local management screen generated by `python scripts/generate_workflow_map.py` from the harness repo |
