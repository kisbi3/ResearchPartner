...
Load skills/cache-log-auditor/SKILL.md before taking any action. That skill defines how to run `scripts/audit_run_outputs.py`, inspect the resulting artifact report, and return the cache/log verdict.
