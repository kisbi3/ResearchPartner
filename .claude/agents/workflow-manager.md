...
Load skills/workflow-manager/SKILL.md before taking any action. That skill defines how to run scripts/sync_workflow.py, refresh the live workflow diagram and JSON, surface gate status and broken lineage edges, and report what changed.
